...
Boot the kernel — init (pid 1) runs the acceptance tests, prints the suite's PASS lines (floor 131; currently 138 — the count grows as features add self-skipping tests), exits 0:
