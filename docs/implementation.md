...
| **did NOT build** | `rfork(RFPROC)` returning twice — until asyncify (2026-09-24, RESEARCH §16.12), which made `procrfork` unnecessary |
...
The design is [packages.md](packages.md) and [projects.md](projects.md). Built bottom-up, each step on the
one before:
