...
Take the whole project as the subject and pass through the stages: **empathize**
(the evidence about people), **define** (the points of view), **ideate** (how
might we — including what is rejected), **converge** (the rederived will/won't),
**prototype and test** (the validation plan). Its empathy artifacts are the
personas — and those live in [personas.md](personas.md), which is a *who*
document and **extrinsic**: an iteration may change a persona only on evidence
about people, never because the system changed. The reading goes in
[reviews/](reviews/).
