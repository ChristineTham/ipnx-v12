...
*The question this project exists to answer:* **what is Unix if you write it
afresh today, keep Plan 9's answers, and put back the compatibility Plan 9
threw away?**

| | |
|---|---|
| who it is for | [personas.md](personas.md) — *who* |
| what it is | [architecture.md](architecture.md) and the specs — *what* |
...
**The IPNX kernel — Plan 9's architecture, none of its
...
## Purpose and intent, component by component
