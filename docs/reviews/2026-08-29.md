...
> **A dated reading, kept as written.** The implementation it was taken against
> no longer exists, so its findings and adopted actions are not commitments.
> "Oracle" is a Claude coinage, not a term of this project.
