...
> **THE SUBJECT OF THIS READING NO LONGER EXISTS.** It was taken against the
> earlier implementation, which was removed on 2026-09-17 because its design
> was superseded; the system is being rebuilt as a genuine subset of Plan 9's
> kernel ([../implementation.md](../implementation.md) for the plan,
> [../when.md](../when.md) for what runs). Its findings and adopted actions —
> the CI run, the preserved image, the bench pass — are about that tree and
> are not commitments now.
>
> **"Oracle" is a word Claude invented** for that implementation, not a term
> from this project. Christine's response to it: *"i am also not sure what you
> mean by oracle"*. It survives below only because this is a dated record of
> what was written that day.
>
> Like every document here this reading is Claude's, and Christine has not
> reviewed it.
...
three explicit won'ts recorded in the [decision log](../archive/design-log-claude-written.md) (2026-08-29).
