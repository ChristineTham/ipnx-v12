...
| **Browser tab** | `poc/browser` (frozen) → `hosts/browser` (M5) | the page's own JIT, Workers + SAB | **green, 149** (floor 131) in Chrome 148 on the reference; canvas v0 + con(1) + edit(1) live in the demo; iPadOS 26.5 Safari (simulator) boots the desktop to rc, measured 2026-08-29; **live at [christham.net/ipnx-v12](https://christham.net/ipnx-v12/)**; Rust core in wasm is M5 |
