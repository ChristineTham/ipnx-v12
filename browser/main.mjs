...
import { boot } from "../supervisor/rustkern.mjs";
...
if (!crossOriginIsolated) {
  document.getElementById("status").textContent = "not isolated"; append("This demo needs cross-origin isolation and this load did not get it. Reload normally — hard reloads bypass the isolation worker and guarantee this screen.\n", "err");
...
const kernelWasm = await (await fetch("../build/kernel.wasm")).arrayBuffer();
